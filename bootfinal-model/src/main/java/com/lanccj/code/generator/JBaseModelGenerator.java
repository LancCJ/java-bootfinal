...
public class JBaseModelGenerator extends BaseModelGenerator {
	...
	public JBaseModelGenerator(String baseModelPackageName,
		...
		this.packageTemplate = "/**%n"
				+ " * Copyright (c) 2015-2016, LancCJ 陈健%n"
				+ " *%n"
		...
		this.importTemplate = "import com.lanccj.message.MessageKit;%n"
				+"import com.lanccj.model.Metadata;%n"
				+ "import com.lanccj.model.core.JModel;%n"
				+ "import com.lanccj.model.query.MetaDataQuery;%n"
